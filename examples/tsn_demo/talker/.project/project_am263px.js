 ...
 * am263px-lp-dp83869/am263px-lp is nested one level deeper than the
 * other boards, so every entry here has one extra ".." vs. am263x's. */
const filedirs = {
    common: [
        "..",                             /* core_os_combo base */
...
const defines_r5f = {
    common: [
        ...
        /* No TSNDEMO_BOARD_AM261X_LP/_SOM needed here: tsndemo_pacing.c only
         * requires that macro inside #if defined(SOC_AM261X) (GENF pacing is
         * AM261x-only) - AM263Px builds skip that #error entirely. */
    ],
};
