...
const files = {
    common: [
        ...
        "tsndemo_pacing.c",
        "tsndemo_stats.c",
        /* shared demo source (examples/tsn_demo/common) */
        "tsndemo_enet.c",
        "tsndemo_dataflow.c",
        "tsndemo_feature.c",
...
const filedirs = {
    common: [
        "..",                          /* core_os_combo base */
        "../../..",                    /* example base (tsn_demo/talker) */
        "../../../../common", /* shared demo source */
        "../../../../../tsn",             /* shared TSN framework */
    ],
};
...
const includes_freertos_r5f = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/networking/enet/core/examples/tsn_demo/common",
        "${MCU_PLUS_SDK_PATH}/source/networking/enet/core/examples/tsn_demo/talker",
...
const libs_freertos_r5f = {
    common: [
        ...
        "yangemb-freertos.am261x.r5f.ti-arm-clang.lib",
    ],
};
...
const defines_r5f = {
    common: [
        ...
        'SITARA',
        /* GPTP_ENABLED is the ONLY TSN framework module enabled; do NOT add
         * EST_APP_ENABLED/AVTP_ENABLED/etc. - EST is configured via direct
         * TAS IOCTLs in tsndemo_feature.c */
        'GPTP_ENABLED=1',
        /* Talker is the gPTP grandmaster (PRIORITY1=200 in gptp_init.c) */
        'GPTP_MASTER=1',
        'TSNDEMO_ROLE_TALKER=1',
        /* required by tsn_gptp/gptpclock.h's UB_LOG macros, must match the
         * category used by the tsn_gptp library build */
        'UB_LOGCAT=3',
...
const readmeDoxygenPageTag = "EXAMPLES_ENET_CPSW_TSN_DEMO_TALKER";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "TsnDemoTalker_mainTask",
            taskPri : "17",
            stackSize : "16384",
        },
    },
...
function getComponentBuildProperty(buildOption) {
    ...
    if(buildOption.cpu.match(/r5f*/)) {
        if(buildOption.os.match(/freertos*/) )
        {
            ...
            /* tsndemo_pacing.c #errors out if neither is defined - it needs
             * to know which board's CPTS ref clock (and therefore tick
             * period) it's running on. Per-board, not a shared default. */
            let defines_r5f_cpy = _.cloneDeep(defines_r5f);
            if (buildOption.board.match(/lp/)) {
                defines_r5f_cpy.common.push('TSNDEMO_BOARD_AM261X_LP=1');
            }
            else if (buildOption.board.match(/som/)) {
                defines_r5f_cpy.common.push('TSNDEMO_BOARD_AM261X_SOM=1');
            }
            build_property.includes = includes_freertos_r5f;
            build_property.libdirs = libdirs_freertos_cpy;
            build_property.libs = libs_freertos_r5f;
            build_property.templates = templates_freertos_r5f;
            build_property.defines = defines_r5f_cpy;
