...
const incfiles = {
    common: [
        "cpsw_fast_startup_common.h",
        "cpsw_fast_startup_cfg.h",
        "cpsw_fast_startup_dataflow.h",
        "enet_profiler.h",
    ],
};
...
const filedirs = {
    common: [
        "..",       /* core_os_combo base */
        "$(MCU_PLUS_SDK_PATH)/source/networking/enet/core/examples/enet_cpsw_fast_startup", /* Example base */
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_ENET_LAYER2_CPSW_FAST_STARTUP_AUTOPHY";
...
const buildOptionCombos = [
    { device: device, cpu: "mcu-r5fss0-0", cgt: "ti-arm-clang", board: "am62dx-evm-dp83tg721/am62dx-evm", os: "nortos"},
];
