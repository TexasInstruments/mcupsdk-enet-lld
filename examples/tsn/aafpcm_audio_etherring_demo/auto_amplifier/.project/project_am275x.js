...
const filedirs = {
    common: [
        "..",       /* core_os_combo base */
        "$(MCU_PLUS_SDK_PATH)/source/networking/enet/core/examples/tsn/aafpcm_audio_etherring_demo/auto_amplifier", /* Example base */
...
function getComponentProperty() {
    ...
    property.name = "autoamp_ring_audio_app";
