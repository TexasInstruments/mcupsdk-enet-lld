...
MEMORY
{
    ...
    R50_0_OCRAM       (RWIX)   : ORIGIN = 0x80080000 LENGTH = 0x00180000          /* 1.5 MB for r5fss0-0 core */
    C75_0_OCRAM_ENTRY (RWIX)   : ORIGIN = 0x80200000 LENGTH = 0x00000040
    C75_0_OCRAM       (RWIX)   : ORIGIN = 0x80200040 LENGTH = 0x00080000 - 0x40 - 0x1000 /* ~512 KB for c75ss0-0 core */
    C75_0_CIO_MEM              : ORIGIN = 0x8027F000 LENGTH = 0x00001000
    AVB_SHM_MEM       (RWIX)   : ORIGIN = 0x80400000 LENGTH = 0x00080000          /* 512 KB for AVB Shared Memory */
    DDR_LOG_SHM_MEM   (RWIX)   : ORIGIN = 0x80480000 LENGTH = 0x00080000          /* 512 KB for Log Shared Memory. */
}
