...
const filedirs = {
    common: [
        "..",       /* core_os_combo base */
        "$(MCU_PLUS_SDK_PATH)/source/networking/enet/core/examples/tsn/avtptalker_crflistener", /* Example base */
...
const readmeDoxygenPageTag = "EXAMPLES_ENET_CPSW_TSN_CRF_AVTP";
...
function getComponentProperty() {
    ...
    property.name = "avtptalker_crflistener";
