...
MEMORY
{
    ...
    R50_0_OCRAM   (RWIX)  : ORIGIN = 0x72080000 , LENGTH = 0x00180000 // 1.5 MB for r5fss0-0 core
    AVB_SHM_MEM           : ORIGIN = 0x72400000 , LENGTH = 0x00080000
    LOG_SHM_MEM           : ORIGIN = 0x72480000 , LENGTH = 0x00080000 // 512 KB for Log Shared Memory.
}
