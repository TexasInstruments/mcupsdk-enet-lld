...
const filedirs = {
    common: [
        "..",       /* core_os_combo base */
        "$(MCU_PLUS_SDK_PATH)/source/networking/enet/core/examples/tsn/aes3_aaf/aes3_aaftalker_app", /* aes3_aaf_listener_app */
...
function getComponentProperty() {
    ...
    property.name = "aes3_aaftalker_app";
