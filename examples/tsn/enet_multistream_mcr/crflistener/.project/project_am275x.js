...
const filedirs = {
    common: [
        "..",       /* core_os_combo base */
        "$(MCU_PLUS_SDK_PATH)/source/networking/enet/core/examples/tsn/enet_multistream_mcr", /* Example base */
...
const readmeDoxygenPageTag = "EXAMPLES_ENET_AVB_MULTISTREAM_MCR";
...
function getComponentProperty() {
    ...
    property.name = "crflistener_tg721_app";
