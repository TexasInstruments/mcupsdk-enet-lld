...
const filedirs = {
    common: [
        "..",                      /* core_os_combo base */
        "$(MCU_PLUS_SDK_PATH)/source/networking/enet/core/examples/tsn/avb_autoamplifier_demo/audio_source_with_crf", /* Example base */
...
function getComponentProperty() {
    ...
    property.name = "crf_multistream_audio_source";
