...
const libs_freertos_r5f_gcc = {
    common: [
        "freertos.am263x.r5f.gcc-armv7.${ConfigName}.lib",
        "drivers.am263x.r5f.gcc-armv7.${ConfigName}.lib",
        "enet-cpsw.am263x.r5f.gcc-armv7.${ConfigName}.lib",
        "board.am263x.r5f.gcc-armv7.${ConfigName}.lib",
        "libc.a",
        "libsysbm.a",
        "tsn_combase-freertos.am263x.r5f.ti-arm-clang.${ConfigName}.lib",
        "tsn_unibase-freertos.am263x.r5f.ti-arm-clang.${ConfigName}.lib",
        "tsn_gptp-freertos.am263x.r5f.ti-arm-clang.${ConfigName}.lib",
        "tsn_uniconf-freertos.am263x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwipif-cpsw-freertos.am263x.r5f.gcc-armv7.${ConfigName}.lib",
        "lwip-freertos.am263x.r5f.gcc-armv7.${ConfigName}.lib",
        "lwip-contrib-freertos.am263x.r5f.gcc-armv7.${ConfigName}.lib",
    ],
};
