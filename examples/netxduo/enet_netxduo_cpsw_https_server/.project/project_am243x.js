...
const readmeDoxygenPageTag = "EXAMPLES_ECLIPSE_THREADX_NETXDUO_CPSW_HTTPS_SERVER";
...
function getComponentProperty() {
    ...
    property.name = "enet_netxduo_cpsw_https_server";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "A simple HTTPS server example for NetxDuo with CPSW."
