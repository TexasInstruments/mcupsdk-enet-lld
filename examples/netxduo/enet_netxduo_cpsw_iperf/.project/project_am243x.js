...
const includes = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/kernel/filex/filex_src/common/inc",
        "${MCU_PLUS_SDK_PATH}/source/kernel/filex/filex_src/ports/generic/inc",
...
const readmeDoxygenPageTag = "EXAMPLES_ECLIPSE_THREADX_NETXDUO_IPERF";
...
function getComponentProperty() {
    ...
    property.name = "enet_netxduo_cpsw_iperf";
