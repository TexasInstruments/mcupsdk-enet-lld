...
const readmeDoxygenPageTag = "EXAMPLES_ECLIPSE_THREADX_NETXDUO_CPSW_SA2UL_TLS_BENCHMARK";
...
function getComponentProperty() {
    ...
    property.name = "enet_netxduo_cpsw_sa2ul_tls_benchmark";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "A simple TLS benchmark using Netx Secure with CPSW and SA2UL hardware acceleration.";
