...
const enet_cpsw_ale_init_vlan_unknown_vlan_force_untagged_egress_config = {
    ...
    config: [
        ...
        {
            name: "unknownVlanForceUntaggedEgressMacPort3En",
            description: "Enable untagged egress for MacPort3",
            displayName: "MacPort3 Untagged Egress",
            default: false,
        },
        {
            name: "unknownVlanForceUntaggedEgressMacPort4En",
            description: "Enable untagged egress for MacPort4",
            displayName: "MacPort4 Untagged Egress",
            default: false,
        },
        {
            name: "unknownVlanForceUntaggedEgressMacPort5En",
            description: "Enable untagged egress for MacPort5",
            displayName: "MacPort5 Untagged Egress",
            default: false,
        },
        {
            name: "unknownVlanForceUntaggedEgressMacPort6En",
            description: "Enable untagged egress for MacPort6",
            displayName: "MacPort6 Untagged Egress",
            default: false,
        },
        {
            name: "unknownVlanForceUntaggedEgressMacPort7En",
            description: "Enable untagged egress for MacPort7",
            displayName: "MacPort7 Untagged Egress",
            default: false,
        },
        {
            name: "unknownVlanForceUntaggedEgressMacPort8En",
            description: "Enable untagged egress for MacPort8",
            displayName: "MacPort8 Untagged Egress",
            default: false,
        },
    ],
    collapsed:true,
...
const enet_cpsw_ale_init_vlan_unknown_vlan_registered_multicast_flood_config = {
    ...
    config: [
        ...
        {
            name: "unknownRegMcastMacPort3En",
            description: "Enable MacPort3 membership for registered multicast address",
            displayName: "MacPort3 Membership Enable",
            default: true,
        },
        {
            name: "unknownRegMcastMacPort4En",
            description: "Enable MacPort4 membership for registered multicast address",
            displayName: "MacPort4 Membership Enable",
            default: true,
        },
        {
            name: "unknownRegMcastMacPort5En",
            description: "Enable MacPort5 membership for registered multicast address",
            displayName: "MacPort5 Membership Enable",
            default: true,
        },
        {
            name: "unknownRegMcastMacPort6En",
            description: "Enable MacPort6 membership for registered multicast address",
            displayName: "MacPort6 Membership Enable",
            default: true,
        },
        {
            name: "unknownRegMcastMacPort7En",
            description: "Enable MacPort7 membership for registered multicast address",
            displayName: "MacPort7 Membership Enable",
            default: true,
        },
        {
            name: "unknownRegMcastMacPort8En",
            description: "Enable MacPort8 membership for registered multicast address",
            displayName: "MacPort8 Membership Enable",
            default: true,
        },
    ],
    collapsed:true,
...
const enet_cpsw_ale_init_vlan_unknown_vlan_unregistered_multicast_flood_config = {
    ...
    config: [
        ...
        {
            name: "unknownUnregMcastMacPort3En",
            description: "Enable MacPort3 membership for unregistered multicast address",
            displayName: "MacPort3 Membership Enable",
            default: true,
        },
        {
            name: "unknownUnregMcastMacPort4En",
            description: "Enable MacPort4 membership for unregistered multicast address",
            displayName: "MacPort4 Membership Enable",
            default: true,
        },
        {
            name: "unknownUnregMcastMacPort5En",
            description: "Enable MacPort5 membership for unregistered multicast address",
            displayName: "MacPort5 Membership Enable",
            default: true,
        },
        {
            name: "unknownUnregMcastMacPort6En",
            description: "Enable MacPort6 membership for unregistered multicast address",
            displayName: "MacPort6 Membership Enable",
            default: true,
        },
        {
            name: "unknownUnregMcastMacPort7En",
            description: "Enable MacPort7 membership for unregistered multicast address",
            displayName: "MacPort7 Membership Enable",
            default: true,
        },
        {
            name: "unknownUnregMcastMacPort8En",
            description: "Enable MacPort8 membership for unregistered multicast address",
            displayName: "MacPort8 Membership Enable",
            default: true,
        },
    ],
...
const enet_cpsw_ale_init_vlan_unknown_vlan_membership_config = {
    ...
    config: [
        ...
        {
            name: "unknownVlanMembershipMacPort3En",
            description: "Enable MacPort3 membership for unknown VLANs",
            displayName: "MacPort3 Membership Enable",
            default: true,
        },
        {
            name: "unknownVlanMembershipMacPort4En",
            description: "Enable MacPort4 membership for unknown VLANs",
            displayName: "MacPort4 Membership Enable",
            default: true,
        },
        {
            name: "unknownVlanMembershipMacPort5En",
            description: "Enable MacPort5 membership for unknown VLANs",
            displayName: "MacPort5 Membership Enable",
            default: true,
        },
        {
            name: "unknownVlanMembershipMacPort6En",
            description: "Enable MacPort6 membership for unknown VLANs",
            displayName: "MacPort6 Membership Enable",
            default: true,
        },
        {
            name: "unknownVlanMembershipMacPort7En",
            description: "Enable MacPort7 membership for unknown VLANs",
            displayName: "MacPort7 Membership Enable",
            default: true,
        },
        {
            name: "unknownVlanMembershipMacPort8En",
            description: "Enable MacPort8 membership for unknown VLANs",
            displayName: "MacPort8 Membership Enable",
            default: true,
        },
    ],
    ...
    config: [
        ...
        },
        {
            ...
            config: [
                ...
                {
                    name: "disableMacAuthMacPort3En",
                    description: "Disable MAC authentication for MacPort3",
                    displayName: "MacPort3 Auth Disable",
                    hidden:true,
                    default: false,
                },
                {
                    name: "disableMacAuthMacPort4En",
                    description: "Disable MAC authentication for MacPort4",
                    displayName: "MacPort4 Auth Disable",
                    hidden:true,
                    default: false,
                },
                {
                    name: "disableMacAuthMacPort5En",
                    description: "Disable MAC authentication for MacPort5",
                    displayName: "MacPort5 Auth Disable",
                    hidden:true,
                    default: false,
                },
                {
                    name: "disableMacAuthMacPort6En",
                    description: "Disable MAC authentication for MacPort6",
                    displayName: "MacPort6 Auth Disable",
                    hidden:true,
                    default: false,
                },
                {
                    name: "disableMacAuthMacPort7En",
                    description: "Disable MAC authentication for MacPort7",
                    displayName: "MacPort7 Auth Disable",
                    hidden:true,
                    default: false,
                },
                {
                    name: "disableMacAuthMacPort8En",
                    description: "Disable MAC authentication for MacPort8",
                    displayName: "MacPort8 Auth Disable",
                    hidden:true,
                    default: false,
                },
            ],
...
const enet_cpsw_port_learning_security_config = {
    ...
    config: [
        ...
        utilsScript.getPortSpecificConfig(enet_cpsw_port_learning_security_config_common, "#", "macPort3"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_learning_security_config_common, "#", "macPort4"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_learning_security_config_common, "#", "macPort5"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_learning_security_config_common, "#", "macPort6"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_learning_security_config_common, "#", "macPort7"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_learning_security_config_common, "#", "macPort8"),
    ],
};
...
const enet_cpsw_port_vlan_security_config = {
    ...
    config: [
        ...
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_security_config_common, "#", "macPort3"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_security_config_common, "#", "macPort4"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_security_config_common, "#", "macPort5"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_security_config_common, "#", "macPort6"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_security_config_common, "#", "macPort7"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_security_config_common, "#", "macPort8"),
    ],
};
...
const enet_cpsw_port_mac_mode_config = {
    ...
    config: [
        ...
        utilsScript.getPortSpecificConfig(enet_cpsw_port_mac_mode_config_common, "#", "macPort3"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_mac_mode_config_common, "#", "macPort4"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_mac_mode_config_common, "#", "macPort5"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_mac_mode_config_common, "#", "macPort6"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_mac_mode_config_common, "#", "macPort7"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_mac_mode_config_common, "#", "macPort8"),
    ],
};
    ...
    config: [
        enet_cpsw_ale_port_vlan_vidinfo_config,
        {
            ...
            config: [
                ...
                {
                    name: "vlanMemberList_#_MacPort3En",
                    displayName: "MacPort3:Enable PVID Membership",
                    description: "Enable macport 3 membership",
                    default: true,
                    hidden:true,
                },
                {
                    name: "vlanMemberList_#_MacPort4En",
                    displayName: "MacPort4:Enable PVID Membership",
                    description: "Enable macport 4 membership",
                    default: true,
                    hidden:true,
                },
                {
                    name: "vlanMemberList_#_MacPort5En",
                    displayName: "MacPort5:Enable PVID Membership",
                    description: "Enable macport 5 membership",
                    default: true,
                    hidden:true,
                },
                {
                    name: "vlanMemberList_#_MacPort6En",
                    displayName: "MacPort6:Enable PVID Membership",
                    description: "Enable macport 6 membership",
                    default: true,
                    hidden:true,
                },
                {
                    name: "vlanMemberList_#_MacPort7En",
                    displayName: "MacPort7:Enable PVID Membership",
                    description: "Enable macport 7 membership",
                    default: true,
                    hidden:true,
                },
                {
                    name: "vlanMemberList_#_MacPort8En",
                    displayName: "MacPort8:Enable PVID Membership",
                    description: "Enable macport 8 membership",
                    default: true,
                    hidden:true,
                },
            ],
        },
        {
            ...
            config: [
                ...
                {
                    name: "unregMcastFloodMask_#_MacPort3En",
                    displayName: "Unregistered Mcast Flood To MacPort3",
                    description: "Enable flood to MacPort3",
                    default: true,
                    hidden:true,
                },
                {
                    name: "unregMcastFloodMask_#_MacPort4En",
                    displayName: "Unregistered Mcast Flood To MacPort4",
                    description: "Enable flood to MacPort4",
                    default: true,
                    hidden:true,
                },
                {
                    name: "unregMcastFloodMask_#_MacPort5En",
                    displayName: "Unregistered Mcast Flood To MacPort5",
                    description: "Enable flood to MacPort5",
                    default: true,
                    hidden:true,
                },
                {
                    name: "unregMcastFloodMask_#_MacPort6En",
                    displayName: "Unregistered Mcast Flood To MacPort6",
                    description: "Enable flood to MacPort6",
                    default: true,
                    hidden:true,
                },
                {
                    name: "unregMcastFloodMask_#_MacPort7En",
                    displayName: "Unregistered Mcast Flood To MacPort7",
                    description: "Enable flood to MacPort7",
                    default: true,
                    hidden:true,
                },
                {
                    name: "unregMcastFloodMask_#_MacPort8En",
                    displayName: "Unregistered Mcast Flood To MacPort8",
                    description: "Enable flood to MacPort8",
                    default: true,
                    hidden:true,
                },
            ],
        },
        {
            ...
            config: [
                ...
                {
                    name: "regMcastFloodMask_#_MacPort3En",
                    displayName: "Registered Mcast Flood To MacPort3",
                    description: "Enable flood to MacPort3",
                    default: true,
                    hidden:true,
                },
                {
                    name: "regMcastFloodMask_#_MacPort4En",
                    displayName: "Registered Mcast Flood To MacPort4",
                    description: "Enable flood to MacPort4",
                    default: true,
                    hidden:true,
                },
                {
                    name: "regMcastFloodMask_#_MacPort5En",
                    displayName: "Registered Mcast Flood To MacPort5",
                    description: "Enable flood to MacPort5",
                    default: true,
                    hidden:true,
                },
                {
                    name: "regMcastFloodMask_#_MacPort6En",
                    displayName: "Registered Mcast Flood To MacPort6",
                    description: "Enable flood to MacPort6",
                    default: true,
                    hidden:true,
                },
                {
                    name: "regMcastFloodMask_#_MacPort7En",
                    displayName: "Registered Mcast Flood To MacPort7",
                    description: "Enable flood to MacPort7",
                    default: true,
                    hidden:true,
                },
                {
                    name: "regMcastFloodMask_#_MacPort8En",
                    displayName: "Registered Mcast Flood To MacPort8",
                    description: "Enable flood to MacPort8",
                    default: true,
                    hidden:true,
                },
        ...
        },
        {
            ...
            config: [
                ...
                {
                    name: "forceUntaggedEgressMask_#_MacPort3En",
                    displayName: "Force Untagged Egress For Macport3",
                    default: false,
                    hidden:true,
                },
                {
                    name: "forceUntaggedEgressMask_#_MacPort4En",
                    displayName: "Force Untagged Egress For Macport4",
                    default: false,
                    hidden:true,
                },
                {
                    name: "forceUntaggedEgressMask_#_MacPort5En",
                    displayName: "Force Untagged Egress For Macport5",
                    default: false,
                    hidden:true,
                },
                {
                    name: "forceUntaggedEgressMask_#_MacPort6En",
                    displayName: "Force Untagged Egress For Macport6",
                    default: false,
                    hidden:true,
                },
                {
                    name: "forceUntaggedEgressMask_#_MacPort7En",
                    displayName: "Force Untagged Egress For Macport7",
                    default: false,
                    hidden:true,
                },
                {
                    name: "forceUntaggedEgressMask_#_MacPort8En",
                    displayName: "Force Untagged Egress For Macport8",
                    default: false,
                    hidden:true,
                },
            ],
...
not in the table, the source address will not be added to the table)`,
            config: [
                ...
                {
                    name: "noLearnMask_#_MacPort3En",
                    displayName: "Disable Learning For Macport3",
                    default: false,
                    hidden:true,
                },
                {
                    name: "noLearnMask_#_MacPort4En",
                    displayName: "Disable Learning For Macport4",
                    default: false,
                    hidden:true,
                },
                {
                    name: "noLearnMask_#_MacPort5En",
                    displayName: "Disable Learning For Macport5",
                    default: false,
                    hidden:true,
                },
                {
                    name: "noLearnMask_#_MacPort6En",
                    displayName: "Disable Learning For Macport6",
                    default: false,
                    hidden:true,
                },
                {
                    name: "noLearnMask_#_MacPort7En",
                    displayName: "Disable Learning For Macport7",
                    default: false,
                    hidden:true,
                },
                {
                    name: "noLearnMask_#_MacPort8En",
                    displayName: "Disable Learning For Macport8",
                    default: false,
                    hidden:true,
                },
            ],
...
const enet_cpsw_port_vlan_config = {
    ...
    config: [
        ...
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_config_common, "#", "macPort3"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_config_common, "#", "macPort4"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_config_common, "#", "macPort5"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_config_common, "#", "macPort6"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_config_common, "#", "macPort7"),
        utilsScript.getPortSpecificConfig(enet_cpsw_port_vlan_config_common, "#", "macPort8"),
    ],
};
