...
function getCpswInstInfo(instance) {
    const cpswInstInfoMap = new Map(
                               [
                                 ['am283x',{enetType: 'ENET_CPSW_3G', numMacPorts: '2', instId: '0', dmaIf:'ENET_SOC_HOSTPORT_DMA_TYPE_UDMA', macPortList:['ENET_MAC_PORT_1', 'ENET_MAC_PORT_2']}],
                               ],
                             );
...
function getBoardConfigTemplateInfo() {
    const boardConfigTemplate = new Map(
                               [
                                 ['am283x',{Cfile: "../ethphy_cpsw_icssg/templates/am283x/enet_board_cfg.c.xdt",
                                  Header: "../ethphy_cpsw_icssg/templates/am283x/enet_board_cfg.h.xdt"}],
                               ],
                             );
...
function getSocConfigTemplateInfo() {
    const socConfigTemplate = new Map(
                               [
                                 ['am283x',{Cfile: "/networking/enet_cpsw/templates/am283x/enet_soc_cfg.c.xdt"}],
                               ],
                             );
...
function getEnetResPartInfo() {
    const ResPartInfoMap = new Map(
                               [
                                 ['am283x',{numCores: 1, coreResInfo: [{txCh: {}, numRxCh: 1, numRxFlows: 1, numMacAddress: 4, numHwPush: 0}], isStaticTxChanAllocated: false}],
                            ],
                             );
