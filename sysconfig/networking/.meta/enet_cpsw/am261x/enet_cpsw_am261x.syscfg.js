...
const enet_cpsw_system_config = {
    ...
    config: [
        ...
        {
            name: "macAddrConfig",
            description: "MAC address to set in the driver. 'Auto Assign shall select the address automatically from EEPROM and/or EFUSES. 'Manual Entry' will allow to input MAC address from sysconfig",
...
function getEnetResPartInfo() {
    const ResPartInfoMap = new Map(
                               [
                                 ['am261x',{numCores: 1, coreResInfo: [{txCh: {}, numRxCh: 1, numRxFlows: 1, numMacAddress: 4, numHwPush: 0}], isStaticTxChanAllocated: false}],
                            ],
                             );
