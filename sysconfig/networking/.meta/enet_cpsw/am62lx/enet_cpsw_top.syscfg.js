...
const enet_clock_config =
    {
        clockIds        : [ "AM62LX_DEV_CPSW0" ],
        clockFrequencies: [
            {
                moduleId: "AM62LX_DEV_CPSW0",
                clkId   : "AM62LX_DEV_CPSW0_CPTS_RFT_CLK",
                clkRate : 200000000,
            },
        ],
    };
...
function getCpswInstInfo(instance) {
    const cpswInstInfoMap = new Map(
                               [
                                 ...
                                 ['am62lx',{enetType: 'ENET_CPSW_3G', numMacPorts: '2', instId: '0', dmaIf:'ENET_SOC_HOSTPORT_DMA_TYPE_UDMA', macPortList:['ENET_MAC_PORT_1', 'ENET_MAC_PORT_2']}],
...
function getBoardConfigTemplateInfo() {
    const boardConfigTemplate = new Map(
                               [
                                 ...
                                 ['am62lx',{Cfile: "../ethphy_cpsw_icssg/templates/am62lx/enet_board_cfg.c.xdt",
                                    Header: "../ethphy_cpsw_icssg/templates/am62lx/enet_board_cfg.h.xdt"}],
...
function getSocConfigTemplateInfo() {
    const socConfigTemplate = new Map(
                               [
                                 ...
                                 ['am62lx',{Cfile: "/networking/enet_cpsw/templates/am62lx/enet_soc_cfg.c.xdt"}],
