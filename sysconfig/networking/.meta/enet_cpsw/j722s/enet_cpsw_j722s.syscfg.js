...
function getCpswInstInfo(instance) {
    const cpswInstInfoMap = new Map(
                               [
                                 ...
                                 ['j722s',{enetType: 'ENET_CPSW_3G', numMacPorts: '2', instId: '0', dmaIf:'ENET_SOC_HOSTPORT_DMA_TYPE_UDMA', macPortList:['ENET_MAC_PORT_1', 'ENET_MAC_PORT_2']}],
                               ],
                             );
...
function getBoardConfigTemplateInfo() {
    const boardConfigTemplate = new Map(
                               [
                                 ...
                                 ['j722s',{Cfile: "../ethphy_cpsw_icssg/templates/j722s/enet_board_cfg.c.xdt",
                                  Header: "../ethphy_cpsw_icssg/templates/j722s/enet_board_cfg.h.xdt"}],
                               ],
                             );
...
function getSocConfigTemplateInfo() {
    const socConfigTemplate = new Map(
                               [
                                 ...
                                 ['j722s',{Cfile: "/networking/enet_cpsw/templates/j722s/enet_soc_cfg.c.xdt"}],
                               ],
                             );
